...
class IMS:
    def __init__(self,root):
        ...
        lbl_footer = Label(self.root, text="IMS-Inventory Management System | Developed by Team - 5\n For any technical issues contact us : 4782934553", font=("times new roman", 12), bg="#4d636d", fg="white").pack(side=BOTTOM, fill=X)
