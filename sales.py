...
class salesClass:
    def __init__(self, root):
        ...
        self.bill_list = []
        lbl_title = Label(self.root, text="Customer Bill Area ", font=("goudy old style", 30, "bold"), bg="#184a45", fg="white", bd=3, relief=RIDGE)
        ...
        # Use pack() after widget creation
        ...
        # Frame for the bill area
        bill_Frame = Frame(self.root, bd=3, relief=RIDGE)
        bill_Frame.place(x=280, y=140, width=410, height=330)

        lbl_title2 = Label(bill_Frame, text="Bill Area", font=("goudy old style", 20, "bold"), bg="orange" )
        ...
        lbl_image=Label(self.root, image=self.bill_photo, bg="white")
